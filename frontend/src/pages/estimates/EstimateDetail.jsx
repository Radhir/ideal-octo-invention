...
import { ArrowLeft, Printer, Download, FileText, CheckCircle, FileDown, Image } from 'lucide-react';
...
const EstimateDetail = () => {
    ...
    return (
        <PortfolioPage breadcrumb="Sales Division / Estimates">
            ...
            <div className="no-print">
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '40px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '15px' }}>
                        ...
                        <PortfolioButton
                            variant="secondary"
                            onClick={() => exportToPDF('estimate-pdf-area', `Quotation_${estimate.job_card_number}.pdf`)}
                            style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#0a0a0a', color: 'var(--gold)' }}
                        >
                            <FileDown size={18} /> Export PDF
                        </PortfolioButton>
                        <PortfolioButton
                            variant="secondary"
                            onClick={() => exportToJPG('estimate-pdf-area', `Quotation_${estimate.job_card_number}.jpg`)}
                            style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#0a0a0a', color: 'var(--gold)' }}
                        >
                            <Image size={18} /> Export JPG
                        </PortfolioButton>
                        <PortfolioButton
                            variant="gold"
            ...
            <div id="estimate-pdf-area">
                <PortfolioCard className="printable-quotation" style={{ padding: '50px', maxWidth: '900px', margin: '0 auto', border: '1px solid var(--gold)', boxShadow: '0 0 50px rgba(176,141,87,0.05)', background: 'var(--bg-dark)' }}>
