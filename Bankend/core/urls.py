...
urlpatterns = [
    ...
    path('api/ppf/', include('ppf_warranty.urls')),
    path('api/ceramic/', include('ceramic_warranty.urls')),
    path('api/job-cards/', include('job_cards.urls')),
    ...
    path('api/pick-and-drop/', include('pick_and_drop.urls')),
