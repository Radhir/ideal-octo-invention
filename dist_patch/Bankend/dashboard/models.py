...
class WorkshopDiary(models.Model):
    ...
    def delete(self, *args, **kwargs):
        raise PermissionError("The Workshop Diary is a permanent historical ledger and cannot be deleted.")
...
class DailyReport(models.Model):
    ...
    def delete(self, *args, **kwargs):
        raise PermissionError("Daily Reports are permanent performance records and cannot be deleted from the archive.")
